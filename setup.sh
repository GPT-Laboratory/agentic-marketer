...
pm2 start venv/bin/python --name newsletter -- app.py
...
echo "✅ Setup complete. Your Flask application 'newsletter' should be running on port 5678 and managed by PM2."
...
echo "🪵 View logs with: pm2 logs newsletter"
